...
function FocusTimerWidget({ onTimerComplete }) {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200/50 shadow-sm flex flex-col items-center justify-center h-full min-h-[360px]">
      <h3 className="font-bold text-lg text-slate-900 mb-4 self-start">Focus Timer</h3>
      ...
      <div className="relative flex items-center justify-center w-40 h-40 mb-6">
        ...
        <div className="absolute flex flex-col items-center justify-center">
          <span className="text-xs font-semibold text-slate-400 tracking-wider uppercase mb-0.5">Focus</span>
          <span className="text-3xl font-bold text-slate-800 tracking-tight">{formatTime(timeLeft)}</span>
        </div>
      </div>
